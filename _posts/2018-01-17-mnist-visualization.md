...
In this post I will create images for all of the filters in each of the four convolutional layers of my model,
and then have the model generate the "perfect" version of each of the 10 digits it has been trained on. My hope is that this will help illuminate how the model goes about turning a bunch of messy pixels of human numeric digits in to nice clean digital representations.
