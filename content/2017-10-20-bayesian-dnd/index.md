...
![center]({{ resize_image(path="Binom-1.png") }})
...
![center]({{ resize_image(path="Beta(1,1)-1.png") }})
...
![center]({{ resize_image(path="Beta(1,19)-1.png") }})
...
![center]({{ resize_image(path="Beta(5,95)-1.png") }})
...
![center]({{ resize_image(path="beta-binomial-updating-example-1.png") }})
...
![center]({{ resize_image(path="beta-binomial-updating-example-two-1.png") }})
...
![center]({{ resize_image(path="200px-2D-simplex.svg.png") }})
...
![center]({{ resize_image(path="unnamed-chunk-2-1.png") }})
...
![center]({{ resize_image(path="unnamed-chunk-3-1.png") }})
...
![center]({{ resize_image(path="d10-1.png") }})
...
![center]({{ resize_image(path="d20-1.png") }})
...
![center]({{ resize_image(path="d12-1.png") }})
...
![center]({{ resize_image(path="d100-1.png") }})
...
![center]({{ resize_image(path="d8-1.png") }})
...
![center]({{ resize_image(path="d6-1.png") }})
...
![center]({{ resize_image(path="d4-1.png") }})
